...
## 2026-04-07 - Added aria-hidden to visual shortcut indicators
**Learning:** Screen readers announce visual keyboard shortcut indicators sequentially (e.g. 'Coffee 2', 'All 1') which confuses users.
**Action:** Always apply `aria-hidden="true"` to small, inline UI elements containing keyboard shortcuts if the parent element already has a proper accessible name or label.
